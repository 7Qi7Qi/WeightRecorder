...
public class LineChartManagerV2 {
    ...
    public LineChartManagerV2(LineChart mLineChart) {
...
//        rightAxis.setAxisMinimum(0f);
    ...
    public void showLineChart(List<Float> xAxisValues, List<Float> yAxisValues, String label, int color) {
        ...
        showLineChart(entries, label, color);
    }
    public void showLineChart(List<Entry> entries, String label, int color) {
        if (initial) {
            initLineChart();
            initial = false;
        }
